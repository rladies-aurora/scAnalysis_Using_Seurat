...
We are going to load in the data using the SeuratData library, if you want to download the data from 10X, then you will follow the following instructions:
